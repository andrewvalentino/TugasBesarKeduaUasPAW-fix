                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('nomor_identitas') ? ' has-error' : '' }}">
                            <label for="nomor_identitas" class="col-md-4 control-label">nomor_identitas</label>
                            <div class="col-md-6">
                                <input id="nomor_identitas" type="number" class="form-control" name="nomor_identitas" value="{{ $data->nomor_identitas }}" maxlength="8" readonly>
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="prodi" required="" disabled="">
                                <option value=""></option>
                                <option value="TF" {{$data->prodi === "TF" ? "selected" : ""}} >Teknik Informatika</option>
                                <option value="SI" {{$data->prodi === "SI" ? "selected" : ""}} >Sistem Informasi</option>
                                <option value="TI" {{$data->prodi === "TI" ? "selected" : ""}} >Teknik Industri</option>
                            </select>
                            </div>
                        </div>
